...
setuptools.setup(
    ...
    install_requires=[
        ...
        'odoo-addon-account_period_lock_date_multi_company>=16.0dev,<16.1dev',
        'odoo-addon-account_reconcile_model_multicompany_propagate>=16.0dev,<16.1dev',
        'odoo-addon-base_company_legal_info>=16.0dev,<16.1dev',
        ...
        'odoo-addon-multicompany_configuration>=16.0dev,<16.1dev',
        ...
        'odoo-addon-project_multi_company>=16.0dev,<16.1dev',
        ...
        'odoo-addon-res_company_access_all_children>=16.0dev,<16.1dev',
        ...
        'odoo-addon-res_partner_category_multi_company>=16.0dev,<16.1dev',
